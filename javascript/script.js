...
for(let i = a; i <= b; i++){
  ...
  if(i < 10){
  imgEl.setAttribute('src', `imagens/home/mandalas/0${i}.jpg`)
  }else{
    imgEl.setAttribute('src', `imagens/home/mandalas/${i}.jpg`)
  }
...
botaoFormularioComprar.forEach(function(botaoComprar) {
    botaoComprar.addEventListener("click", function() {
      for(let i = 1; i <= 86; i++){
        ...
        }else if(i == 11 || i == 12 || (i >= 56 && i < 67) || (i == 84)){
